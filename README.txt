...
Just follow these few steps:
	...
	3.1) Put the XML Qualys files into the six sequential directories you find in the main 
	     folder. Each directory represents what we call a "snapshot".
...
NB: During step 3.1, it is important to leave just the xml file of Qualys in the directories. 
Snapshot will provide to parse them and generate a summary (header.txt and body.txt). If you have
less than six analysis leave the extra folders empty.
